...
export const HomePage = () => {
  return (
    <Container fluid={'sm'} className={'text-center'}>
      <Row>
        <Col>
          <h1>Тестовое задание резиновая верстка таблицы</h1>
          <p className={'fs-4 mt-4'}>
            Здесь я реализовал два варианта резиновой таблицы. В первом варианте (scrolled table)
            ...
            нажатию по ссылкам в хедэре.При выборе статуса задачи <i>выполнено</i> задача уходит в
            раздел выполненных и наоборот.
          </p>
